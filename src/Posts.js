...
function Post(props) {
    ...
    return (
        <div class="Post">
            <div class="Post-user">
                <div>
                    <div class="User-photo">
                        ...
                        <img class="Only" src={props.userImg} alt={props.userName} />
                    </div>
            ...
            <div class="Post-img">
                <img src={props.postImg} alt="Imagem de post" />
            </div>
            ...
            <div class="Post-informations">
                <div class="Likes">
                    <img src={props.userLikedImg} alt="Curtiu a publicação" />
                    <p> Curtido por <strong class="Liked-by">{props.userLiked}</strong> e <strong>outras
                        pessoas</strong></p>
                </div>

                <div class="Post-caption">
                    <p><strong>{props.userName}</strong> {props.postCaption}</p>
                </div>

                <Comment
                    comments={props.comments}
                    userComment1={props.userComment1}
                    comment1={props.comment1}
                    userComment2={props.userComment2}
                    comment2={props.comment2}
                />

                <div class="Post-time">
                    <span>Há {props.time}</span>
                </div>
            </div>
